...
// const BASE_URL = "https://localhost:7275/api/Task";
...
//   return await axios.get("https://localhost:7275/api/Task/with-details");
// };
// // ✅ Add a new Task
// export const addTask = (Task) => axios.post(API_URL + "Save", Task);

// // ✅ Update an existing Task
// export const updateTask = (Task) => axios.put(`${API_URL}Update/${Task.TaskId}`, Task);
